  ...
  if (approved !== true) {
    return (
      <div className="flex h-full flex-col items-center justify-center gap-3 text-center">
        <p className="text-sm font-semibold text-slate-700">Acceso pendiente</p>
    ...
    return (
      <div className="flex h-full flex-col items-center justify-center gap-3 text-center">
        <p className="text-sm font-semibold text-slate-700">
          {isDisabled ? "Acceso deshabilitado" : "Acceso pendiente"}
        </p>
        <p className="text-xs text-slate-500">
          {isDisabled ? "Tu cuenta está inactiva. Contacta al administrador." : "Tu acceso está pendiente de aprobación."}
        </p>
        <button
          className="rounded-full border border-slate-200/60 px-4 py-2 text-xs font-semibold text-slate-600"
          onClick={() => {
